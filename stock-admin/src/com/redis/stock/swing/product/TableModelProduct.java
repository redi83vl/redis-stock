 ...
 */
public class TableModelProduct implements javax.swing.table.TableModel{
	...
	public Object getValueAt(int i, int i1) {
		switch(i1) {
			...
			case 4: return products.get(i).getSize();
			case 5: return products.get(i).getCost();
			case 6: return products.get(i).getValue();
			case 7: return products.get(i).getPrice();
			case 8: return products.get(i).getTax();
			default: return null;
		}
	}
