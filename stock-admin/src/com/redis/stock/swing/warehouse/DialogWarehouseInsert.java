 ...
 */
public class DialogWarehouseInsert extends javax.swing.JDialog {
	
	public DialogWarehouseInsert(java.awt.Frame parent) {
		super(parent, true);
	...
	@SuppressWarnings("unchecked")
     ...
     private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		boolean success = Warehouses.getDataset().insert(this.get());
		if(!success)
