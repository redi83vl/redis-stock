 ...
 */
public class TableModelWarehouse implements javax.swing.table.TableModel{

	private final List<TableModelListener> listeners;
	private final List<Warehouse> customers;

	public TableModelWarehouse() {
		this.customers = new ArrayList<>();
		this.listeners = new ArrayList<>();
	}
	
	public void add(Warehouse customer) {
	...
	public void remove(Warehouse customer) {
