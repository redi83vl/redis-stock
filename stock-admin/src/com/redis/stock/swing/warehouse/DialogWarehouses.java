 ...
 */
package com.redis.stock.swing.warehouse;
 ...
 */
public class DialogWarehouses extends javax.swing.JDialog {
	
	public DialogWarehouses(java.awt.Frame parent) {
		super(parent, true);
		...
		this.jXTable1.getSelectionModel().addListSelectionListener((ListSelectionEvent lse) -> {
			DialogWarehouses.this.onSelect();
		});
	}
		
	private void reload() {
		this.tableModel.clear();	
		Warehouses.getDataset().forEach(customer -> {
	...
	@SuppressWarnings("unchecked")
     ...
     private void initComponents() {
          ...
          tableModel = new com.redis.stock.swing.warehouse.TableModelWarehouse();
     ...
     private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
          DialogWarehouseInsert dialog = new DialogWarehouseInsert((Frame) SwingUtilities.windowForComponent(this));
		dialog.addWindowListener(new WindowAdapter() {
			@Override
			public void windowClosed(WindowEvent we) {DialogWarehouses.this.reload();}
		});
     ...
     private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
          Warehouse customer = this.getSelected();
		if(customer != null) {
			DialogWarehouseInsert dialog = new DialogWarehouseInsert((Frame) SwingUtilities.windowForComponent(this));
			dialog.addWindowListener(new WindowAdapter() {
				@Override
     ...
     private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
		...
		if(warehouse != null) {
			...
			if(choice == 0){
				...
				boolean success = Warehouses.getDataset().delete(warehouse);
				if(success){
					tableModel.remove(warehouse);	
					DialogWarehouses.this.reload();
				}
				else{
     ...
     private com.redis.stock.swing.warehouse.TableModelWarehouse tableModel;
