 ...
 */
public class DialogSupplierInsert extends javax.swing.JDialog {
	
	public DialogSupplierInsert(java.awt.Frame parent) {
		super(parent, true);
	...
	public Supplier get() {
		...
		return new Supplier(code, name, address, phone, email);
	}
	...
	@SuppressWarnings("unchecked")
     ...
     private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		boolean success = Suppliers.getDataset().insert(this.get());
		if(!success)
