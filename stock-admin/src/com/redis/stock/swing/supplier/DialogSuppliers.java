 ...
 */
public class DialogSuppliers extends javax.swing.JDialog {
	
	public DialogSuppliers(java.awt.Frame parent) {
		super(parent, true);
		...
		this.jXTable1.getSelectionModel().addListSelectionListener((ListSelectionEvent lse) -> {
			DialogSuppliers.this.onSelect();
		});
	}
		
	private void reload() {
		this.tableModel.clear();	
		Suppliers.getDataset().forEach(customer -> {
	...
	@SuppressWarnings("unchecked")
     ...
     private void initComponents() {
          ...
          tableModel = new com.redis.stock.swing.supplier.TableModelSupplier();
     ...
     private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
          DialogSupplierInsert dialog = new DialogSupplierInsert((Frame) SwingUtilities.windowForComponent(this));
		dialog.addWindowListener(new WindowAdapter() {
			@Override
			public void windowClosed(WindowEvent we) {DialogSuppliers.this.reload();}
		});
     ...
     private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
          Supplier customer = this.getSelected();
		if(customer != null) {
			DialogSupplierInsert dialog = new DialogSupplierInsert((Frame) SwingUtilities.windowForComponent(this));
			dialog.addWindowListener(new WindowAdapter() {
				@Override
     ...
     private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
		...
		if(supplier != null) {
			...
			if(choice == 0){
				...
				boolean success = Suppliers.getDataset().delete(supplier);
				if(success){
					tableModel.remove(supplier);	
					DialogSuppliers.this.reload();
				}
				else{
     ...
     private com.redis.stock.swing.supplier.TableModelSupplier tableModel;
