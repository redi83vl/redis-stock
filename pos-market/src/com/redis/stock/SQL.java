...
public class SQL {	
	...
	public static void setUsername(String username) {SQL.PREFERENCES.put("sql_pos_username", username);}
	public static void setPassword(String password) {SQL.PREFERENCES.put("sql_pos_password", password);}
