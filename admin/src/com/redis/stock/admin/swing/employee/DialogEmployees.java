 ...
 */
public class DialogEmployees extends javax.swing.JDialog {
		
	public DialogEmployees(java.awt.Frame parent) {
		super(parent, true);
		initComponents();
	}
	...
	public Employee getEmployee() {
		...
		return row == -1 ? null : Employee.read((String) jXTable1.getValueAt(row, 0));
	}
	...
	@SuppressWarnings("unchecked")
     ...
     private void initComponents() {
          ...
          tableModel = new com.redis.stock.admin.swing.employee.TableModelEmployees();
     ...
     private void buttonRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRefreshActionPerformed
          this.tableModel.setEmployees(Employee.read());
     ...
     private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
          DialogEmployeeCreate dialog = new DialogEmployeeCreate((Frame) SwingUtilities.windowForComponent(this));
     ...
     private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
		...
		if(employee != null) {
			...
			if(choice == 0){
				int id = Employee.delete(employee);		
				if(id == -1) 
     ...
     private com.redis.stock.admin.swing.employee.TableModelEmployees tableModel;
