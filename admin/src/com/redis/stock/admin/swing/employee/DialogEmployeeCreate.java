 ...
 */
public class DialogEmployeeCreate extends javax.swing.JDialog {
		
	public DialogEmployeeCreate(java.awt.Frame parent) {
		super(parent, true);
		initComponents();
	}
	
	public void setEmployee(Employee employee) {
		this.fieldCode.setText(employee.getCode());
		this.fieldName.setText(employee.getName());
		this.fieldAddress.setText(employee.getAddress());
		this.fieldPhone.setText(employee.getPhone());
		this.fieldEmail.setText(employee.getEmail());
