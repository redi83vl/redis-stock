 ...
 */
public class DialogSupplierList extends javax.swing.JDialog {
		
	public DialogSupplierList(java.awt.Frame parent) {
		super(parent, true);
		initComponents();
	}
	...
	public Supplier getSupplier() {
		...
		return row == -1 ? null : Supplier.read((String) table.getValueAt(row, 0));
	}
	...
	@SuppressWarnings("unchecked")
     ...
     private void initComponents() {
          ...
          tableModel = new com.redis.stock.admin.swing.supplier.TableModelSupplier();
          ...
          if (table.getColumnModel().getColumnCount() > 0) {
               ...
               table.getColumnModel().getColumn(2).setHeaderValue("Adresa");
               table.getColumnModel().getColumn(3).setPreferredWidth(150);
               table.getColumnModel().getColumn(3).setHeaderValue("Telefoni");
     ...
     private void buttonRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRefreshActionPerformed
          this.tableModel.setSuppliers(Supplier.read());
     ...
     private void jXSearchField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jXSearchField1ActionPerformed
          this.table.setRowFilter(RowFilter.regexFilter("(?i)" + this.jXSearchField1.getText(), 0, 1));
     }//GEN-LAST:event_jXSearchField1ActionPerformed

     private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
          DialogSupplier dialog = new DialogSupplier((Frame) SwingUtilities.windowForComponent(this));
     ...
     private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
		...
		if(supplier != null) {
			...
			if(choice == 0){
				int id = Supplier.delete(supplier);		
				if(id == -1) 
     ...
     private com.redis.stock.admin.swing.supplier.TableModelSupplier tableModel;
