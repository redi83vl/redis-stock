 ...
 */
public class DialogClientCreate extends javax.swing.JDialog {
		
	public DialogClientCreate(java.awt.Frame parent) {
		super(parent, true);
		initComponents();
	}
	
	public void setClient(Client client) {
		this.fieldCode.setText(client.getCode());
		this.fieldName.setText(client.getName());
		this.fieldAddress.setText(client.getAddress());
		this.fieldPhone.setText(client.getPhone());
		this.fieldEmail.setText(client.getEmail());
