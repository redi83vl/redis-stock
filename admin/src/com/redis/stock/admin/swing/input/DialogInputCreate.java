 ...
 */
public class DialogInputCreate extends javax.swing.JDialog {
	
	private final List<Employee> authors = Employee.read();
	private final List<Supplier> sources = Supplier.read();
	private final List<Product> products = Product.read();
	
	
	public DialogInputCreate(java.awt.Frame parent) {
		super(parent, true);
		initComponents();
	...
	@SuppressWarnings("unchecked")
     ...
     private void initComponents() {
          ...
          jPanel1Layout.setHorizontalGroup(
               ...
               .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                         .addGroup(jPanel1Layout.createSequentialGroup()
                              .addComponent(comboSource, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
     ...
     private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          Input input = Input.create(
			...
			(Supplier) comboSource.getSelectedItem(), 
     ...
     private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
		...
		sources.forEach(client -> {
			comboSource.addItem(client);
		});
     ...
     private void jXSearchField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jXSearchField1ActionPerformed
		...
		tableModel.addRow(product.getCode(), product.getName(), product.getUnit());		
          ...
          if(evt.getClickCount() == 2) {
			DialogProducts dialoag = new DialogProducts((Frame) SwingUtilities.windowForComponent(this)) {
				...
				public void productSelected(Product product) {
					tableModel.addItem(new Item(product.getCode(), product.getName(), product.getUnit(), 1.0d, 0.0d, 0.0d));
				}
			};
     ...
     private javax.swing.JComboBox<Supplier> comboSource;
