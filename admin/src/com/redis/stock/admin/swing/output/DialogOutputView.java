 ...
 */
public class DialogOutputView extends javax.swing.JDialog {
	
	private Output output = null;
	
	public DialogOutputView(java.awt.Frame parent) {
		super(parent, true);
		initComponents();
	...
	public void setOutput(Output output) {
		this.setTitle("Flete Dalje (Shitje): " + output.getCode());
		this.fieldInstant.setValue(Date.from(output.getInstant()));
		this.fieldAuthor.setValue(output.getAuthor());
		this.fieldTarget.setValue(output.getTarget());
		this.checkBoxPaid.setSelected(output.isPaid());
		this.fieldValue.setValue(output.getGrossValue());
		
		this.tableModel.setItems(output);
	...
	@SuppressWarnings("unchecked")
     ...
     private void initComponents() {
          ...
          fieldTarget = new javax.swing.JFormattedTextField();
          ...
          jPanel1Layout.setHorizontalGroup(
               ...
               .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                         .addGroup(jPanel1Layout.createSequentialGroup()
                              .addComponent(fieldTarget, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
          ...
          jPanel1Layout.setVerticalGroup(
               ...
               .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                         .addComponent(jLabel3)
                         .addComponent(fieldTarget, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                         .addComponent(fieldValue, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                         .addComponent(checkBoxPaid))
                    .addContainerGap())
          );
     ...
     private void checkBoxPaidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkBoxPaidActionPerformed
		...
		this.output.setPaid(checkBoxPaid.isSelected());
		this.checkBoxPaid.setSelected(output.isPaid());
     }//GEN-LAST:event_checkBoxPaidActionPerformed

     private void buttonPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonPrintActionPerformed
		try {
			Desktop.getDesktop().open(Output.toHtml(output));
		} 
		catch (IOException ex) {
			Logger.getLogger(DialogOutputView.class.getName()).log(Level.SEVERE, null, ex);
		}
     ...
     private javax.swing.JFormattedTextField fieldTarget;
