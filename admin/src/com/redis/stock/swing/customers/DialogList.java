...
public abstract class DialogList extends javax.swing.JDialog {
	...
	private void reload() {
		...
		DialogList.this.getDataset().forEach(customer -> {
	...
	@SuppressWarnings("unchecked")
     ...
     private void initComponents() {
          ...
          tableModel = new com.redis.stock.swing.customers.TableModel();
     ...
     private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
          DialogAdd dialog = new DialogAdd((Frame) SwingUtilities.windowForComponent(this)) {
			@Override
			public Dataset<Customer> getDataset() {return DialogList.this.getDataset();}
		};
     ...
     private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
		...
		if(customer != null) {
			...
			if(choice == 0){
				boolean success = this.getDataset().remove(customer);
				if(success){
     ...
     private com.redis.stock.swing.customers.TableModel tableModel;
