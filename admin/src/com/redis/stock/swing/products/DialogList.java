 ...
 */
public abstract class DialogList extends javax.swing.JDialog {
	
	public DialogList(java.awt.Frame parent) {
		super(parent, true);
		initComponents();
	...
	private void reload() {
		...
		DialogList.this.getDataset().forEach(product -> {
	...
	public Product get(int idx) {
		...
		if(idx != -1) {
			...
			product = this.tableModel.get(idx);			
		}
		return product;
	}
	...
	@SuppressWarnings("unchecked")
     ...
     private void initComponents() {
          ...
          tableModel = new com.redis.stock.swing.products.TableModel();
          ...
          if (jXTable1.getColumnModel().getColumnCount() > 0) {
               ...
               jXTable1.getColumnModel().getColumn(4).setHeaderValue("Kosto");
               jXTable1.getColumnModel().getColumn(5).setPreferredWidth(50);
               jXTable1.getColumnModel().getColumn(5).setHeaderValue("Blerje");
               jXTable1.getColumnModel().getColumn(6).setPreferredWidth(50);
               jXTable1.getColumnModel().getColumn(6).setHeaderValue("Shitje");
               jXTable1.getColumnModel().getColumn(7).setPreferredWidth(50);
               jXTable1.getColumnModel().getColumn(7).setHeaderValue("Tatim");
          }
     ...
     private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
          DialogAdd dialog = new DialogAdd((Frame) SwingUtilities.windowForComponent(this)) {
			@Override
			public Dataset<Product> getDataset() {return DialogList.this.getDataset();}
		};
		dialog.addWindowListener(new WindowAdapter() {
			@Override
			public void windowClosed(WindowEvent we) {DialogList.this.reload();}
		});
     ...
     private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
          Product product = this.getSelected();
		if(product != null) {
			DialogAdd dialog = new DialogAdd((Frame) SwingUtilities.windowForComponent(this)) {
				@Override
				public Dataset<Product> getDataset() {return DialogList.this.getDataset();}
     ...
     private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
		...
		if(product != null) {
			...
			if(choice == 0){
				boolean success = this.getDataset().remove(product);
				if(success){
     ...
     private com.redis.stock.swing.products.TableModel tableModel;
