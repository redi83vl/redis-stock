...
public abstract class DialogList extends javax.swing.JDialog {
	...
	public abstract Dataset<Supplier> getDataset();
	
	private void reload() {
		this.tableModel.clear();
		this.jXSearchField1.setText("");		
		DialogList.this.getDataset().forEach(supplier -> {
			tableModel.add(supplier);
		});
	...
	public Supplier get(int idx) {
		...
		if(idx != -1) {
			...
			supplier = this.tableModel.get(idx);			
		}
		return supplier;
	}
	...
	@SuppressWarnings("unchecked")
     ...
     private void initComponents() {
          ...
          tableModel = new com.redis.stock.swing.suppliers.TableModel();
     ...
     private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
          DialogAdd dialog = new DialogAdd((Frame) SwingUtilities.windowForComponent(this)) {
			@Override
			public Dataset<Supplier> getDataset() {return DialogList.this.getDataset();}
		};
     ...
     private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
		...
		if(supplier != null) {
			...
			if(choice == 0){
				boolean success = this.getDataset().remove(supplier);
				if(success){
					tableModel.remove(supplier);			
				}
				else{
     ...
     private com.redis.stock.swing.suppliers.TableModel tableModel;
