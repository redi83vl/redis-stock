...
public abstract class DialogAdd extends javax.swing.JDialog {
	...
	public DialogAdd(java.awt.Frame parent) {
		...
		this.fieldCode.getDocument().addDocumentListener(new DocumentListener() {
			@Override
			public void insertUpdate(DocumentEvent de) {validateWarehouse();}
			@Override
			public void removeUpdate(DocumentEvent de) {validateWarehouse();}
			@Override
			public void changedUpdate(DocumentEvent de) {validateWarehouse();}
		});
	...
	public Warehouse getWarehouse() {
		...
		return new Warehouse(code, name, address, phone, email);
	}
	
	public void setWarehouse(Warehouse warehouse) {
		this.fieldCode.setText(warehouse.getCode());
		this.fieldName.setText(warehouse.getName());
		this.fieldAddress.setText(warehouse.getAddress());
		this.fieldPhone.setText(warehouse.getPhone());
		this.fieldEmail.setText(warehouse.getEmail());
	...
	@SuppressWarnings("unchecked")
     ...
     private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		boolean success = Warehouses.getDataset().add(this.getWarehouse());
		if(!success)
