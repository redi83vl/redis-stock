...
public abstract class DialogList extends javax.swing.JDialog {
	...
	public abstract Dataset<Warehouse> getDataset();
	
	private void reload() {
		this.tableModel.clear();
		this.jXSearchField1.setText("");
		DialogList.this.getDataset().forEach(warehouse -> {
			tableModel.add(warehouse);
		});
	...
	public Warehouse get(int idx) {
		...
		if(idx != -1) {
			...
			warehouse = this.tableModel.get(idx);			
		}
		return warehouse;
	}
	...
	@SuppressWarnings("unchecked")
     ...
     private void initComponents() {
          ...
          tableModel = new com.redis.stock.swing.warehouses.TableModel();
     ...
     private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
          DialogAdd dialog = new DialogAdd((Frame) SwingUtilities.windowForComponent(this)) {
			@Override
			public Dataset<Warehouse> getDataset() {return DialogList.this.getDataset();}
		};
     ...
     private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
          Warehouse warehouse = this.getSelected();
		if(warehouse != null) {
			DialogAdd dialog = new DialogAdd((Frame) SwingUtilities.windowForComponent(this)) {
				@Override
				public Dataset<Warehouse> getDataset() {return DialogList.this.getDataset();}
     ...
     private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
		...
		if(warehouse != null) {
			...
			if(choice == 0){
				boolean success = this.getDataset().remove(warehouse);
				if(success){
					tableModel.remove(warehouse);			
				}
				else{
     ...
     private com.redis.stock.swing.warehouses.TableModel tableModel;
